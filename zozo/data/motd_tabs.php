...
<div id="kf-content">
  <center>
  <a href="http://www.gametracker.com/server_info/78.139.77.165:7707/" target="_blank"><img src="http://cache.www.gametracker.com/server_info/78.139.77.165:7707/b_560_95_1.png" border="0" width="560" height="95" alt=""/></a>
  <a href="http://www.gametracker.com/server_info/78.139.77.165:7807/" target="_blank"><img src="http://cache.www.gametracker.com/server_info/78.139.77.165:7807/b_560_95_1.png" border="0" width="560" height="95" alt=""/></a>
  </center>
</div>

<div id="chat-content">
  <div class="monitoring">
     <a href="http://zo-zo.org/320-commfort-5-10/" title="Зайти в /.ZoZo./ CommFort Чат"><img class="commfort-banner" src="http://zo-zo.org/wp-content/themes/zozo-theme/images/commfort_banner.jpg" alt="/.ZoZo./ CommFort Чат"></a>
  </div>
  <div class="discription">
   <h2>CommFort Чат /.ZoZo./ Zombie Zone</h2>
   <h2><a href="http://zo-zo.org/320-commfort-5-10/" title="Зайти в /.ZoZo./ CommFort Чат">подключение</a></h2>
   <ul>
    <li>Пересылка сообщений.</li>
    <li>Использование аудио и видео связи.</li>
    <li>Вставки картинок из буфера обмена прямо в окно чата.</li>
    <li>Отправка сообщения на сервере в отсутствии пользователя-получателя.</li>
    <li>Забавные смайлы.</li>
    <li>Стабильно работающая индикация активности программы.</li>
    <li>Мониторинг серверов Left 4 Dead 2 из чата.</li>
    <li>Возможность передачи как отдельных файлов, так и папок с файлами.</li>
    <li>Удобная система просмотра информации о пользователях.</li>
   </ul>
  </div>
  <br class="clear">
</div>